    ...
    return (
      <TouchableOpacity
        style={[
          ...
          {
            backgroundColor: isRead ? theme.card : theme.cardHighlight,
          ...
          {isBudgetOverrun && (
            <View style={styles.budgetDetails}>
              <View style={styles.budgetDetail}>
                <Text style={[styles.budgetDetailLabel, { color: theme.textSecondary }]}>
                  Budget:
                </Text>
              ...
              <View style={styles.budgetDetail}>
                ...
                <Text style={[styles.budgetDetailValue, { color: theme.expense }]}>
