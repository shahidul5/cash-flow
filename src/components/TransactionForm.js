...
const TransactionForm = ({ transaction, onSubmit, onCancel, initialType, initialPaymentMethod }) => {
  ...
  const [paymentMethod, setPaymentMethod] = useState(initialPaymentMethod || 'cash'); // 'cash' or 'bank'
  ...
  const validateForm = () => {
    ...
    if (type === 'expense' && paymentMethod === 'bank' && selectedBankId) {
      ...
      if (selectedBank && parseFloat(amount) > parseFloat(selectedBank.balance)) {
  ...
  return (
    ...
    >
      <ScrollView>
        <View style={styles.typeSelector}>
          <TouchableOpacity
            style={[
              ...
              { borderColor: theme.border, backgroundColor: type === 'expense' ? theme.expense : 'transparent' }
            ]}
          ...
          <TouchableOpacity
            style={[
              ...
              { borderColor: theme.border, backgroundColor: type === 'income' ? theme.income : 'transparent' }
            ]}
            ...
            {getCategories().map((cat) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  category === cat.name && {
                    backgroundColor: type === 'income' ? theme.income : cat.color || theme.expense,
                  },
          ...
          <View style={styles.paymentMethodContainer}>
            ...
            <TouchableOpacity
              style={[
                ...
                {
                  borderColor: theme.border,
                  backgroundColor: paymentMethod === 'bank' ? theme.primary : 'transparent'
                }
              ]}
        ...
        {paymentMethod === 'bank' && (
          <View style={styles.formGroup}>
            <Text style={[styles.label, { color: theme.text }]}>Select Bank Account</Text>
            ...
            {errors.bank && <Text style={[styles.errorText, { color: theme.error }]}>{errors.bank}</Text>}
          </View>
        )}
